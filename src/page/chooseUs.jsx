...
export default function ChooseUs() {
    ...
    return (/* bg-primary/5 = 5 % tint of your accent color; change to any Tailwind color you like */
        <section className="py-20 bg-primary/5" id="why-choose-us">
            <div className="container mx-auto px-3 max-w-6xl">
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
                    {features.map((item, index) => (<div
                        key={index}
                        className="flex items-start gap-4 p-3 bg-white/90 backdrop-blur border border-white/60 shadow-sm hover:shadow-md transition rounded-xl">
                        <span className="shrink-0 w-6 h-6 mt-1">
                             <svg id="Layer_1" enableBackground="new 0 0 150 150" viewBox="0 0 1000 150" className={"h-9"}
